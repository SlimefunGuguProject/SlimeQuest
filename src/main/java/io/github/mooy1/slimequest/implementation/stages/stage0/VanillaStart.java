package io.github.mooy1.slimequest.implementation.stages.stage0;
...
public class VanillaStart extends QuestPage {
    public VanillaStart() {
        ...
        quests.add(new Quest("Coal", 2, "You're gonna need a lot of this", 12, "COAL",
                new int[] {13, 14}, new int[]{1}, new String[]{"COAL"}, new int[]{16}).setLevels(333)
        );
        quests.add(new Quest("Furnace", 3, "Tier 0 furnace", 42, "FURNACE",
                new int[] {33, 24}, new int[]{1}, new String[]{"FURNACE"}, new int[]{1}).setConsume().setLevels(777).setCustomReq("EEEE").setReward("VOID_INGOT", 1)
        );
